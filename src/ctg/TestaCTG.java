...
public class TestaCTG {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null,"Gastos mensais: " + centro.retornarGastos(numinteg, mensalidade) + "\nPorte: " + centro.retornarPorte(numinteg));
        ...
        {
            JOptionPane.showMessageDialog(null, "Atividades e rendimento:" + centro.atividades(true, true));
        }
